...
b = a.charAt(a.length - 1) //sama kyk diatas
b = a.slice(1, 4);   //"ell" gada a[1:3] | ditambah 1 dari last idx 
b = a.slice(-2);     // dari last index ambil 2
...
function capitalice() { return this.charAt(0).toUpperCase() + this.slice(1).toLowerCase();};
function capitalizeEachWord() { var arr = this.split(" "); var res = []; for (i of arr) { res.push(i.charAt(0).toUpperCase() + i.slice(1).toLowerCase());} return res.join(" "); };
...
e = d.capitalizeEachWord(); //Hallo Guys David Disini
